...
* **Actuation Timing:** Trigger the vacuum valve early in the slow-shot phase ($V_1$) and cut it off precisely **$0.02$ seconds** before the fast-shot phase ($V_2$) peak pressure is reached.
